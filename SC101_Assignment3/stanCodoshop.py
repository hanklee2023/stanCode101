...
def get_average(pixels):
    ...
    avg_r, avg_g, avg_b = sum(p.red for p in pixels)/len(pixels), \
                          sum(p.green for p in pixels)/len(pixels), sum(p.blue for p in pixels)/len(pixels)
